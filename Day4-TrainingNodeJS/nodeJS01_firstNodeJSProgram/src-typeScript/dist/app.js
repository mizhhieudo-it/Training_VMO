...
http
    ...
    let url = req.url;
    if (url === "/") {
        DemoController_1.DemoContoller.index(req, res);
    }
    else if (url === "/create-profile.html") {
        DemoController_1.DemoContoller.LayoutCreateProfiles(req, res);
    }
    else if (url == "/fileupload")
        DemoController_1.DemoContoller.WriteFileProfiles(req, res);
    else {
